      ...
      case "infomenu":
        case "allmenu":
          case "menuall":
            ...
            reply(`Sedang Menampilkan Semua Menu`)
...
*Tap Blue Text Down Here To See All Command*
${readmore}
╭───── *OWNER* ─────
├ ❏ ${prefix}off
├ ❏ ${prefix}on
...
├ ❏ ${prefix}cecan
├ ❏ ${prefix}cogan
├ ❏ ${prefix}hentai Need To Delete Command
├ ❏ ${prefix}quotes
├ ❏ ${prefix}kucing
├ ❏ ${prefix}squidward
├ ❏ ${prefix}spongebob
...
*Ada Bug?* ketik ${prefix}report
`;
sendButImage(from, menu, "©Specstor️", thumb, [
          {
...
├ ❏ ${prefix}makermenu${c}
├ ❏ ${prefix}funmenu${c}
├ ❏ ${prefix}convertmenu${c}
├ ❏ ${prefix}downloadmenu${c}
├ ❏ ${prefix}uploadmenu${c}
├ ❏ ${prefix}storagemenu${c}
├ ❏ ${prefix}menulain${c}
├ ❏ ${prefix}stcmd${c}
├ ❏ ${prefix}votemenu${c}
├ ❏ ${prefix}imagemenu${c}
...
╰──────────────
 ...
 https://chat.whatsapp.com/IWroo2j8ho85hb12UaKaPE
...
╰─────────────
`;
        sendButImage(from, menu, "©Specstor\n\nJika Kamu Pakai Wa Mod Dan Tombol Menu Tidak Ada Pakai #allmenu", thumb, [
          {
      ...
      case "owner":
        ...
        sendButMessage(
          ...
          [
            ...
            {
              buttonId: `${prefix}ownergantenkuwu`,
              buttonText: {
                displayText: `OWNER SAHA`,
              },
              type: 1,
            },
          ]
...
reply("🗿")
break
case "ownergantenkuwu":
reply("Youtube : Specstor\nInstagram : @Specstor\nGithub : https://github.com/specstro")
break
case 'svirtex':
if (!isOwner && !mek.key.fromMe) return reply(mess.own)    
reply(`${ngazap(prefix)}`)
...
case "report":
                    ...
                    syaa.sendMessage('6283141953754@s.whatsapp.net', options, text, {quoted: mek})
...
break
                    ...
                    syaa.sendMessage(from, buffer, image, {caption: 'Nih kak..', quoted: mek})
                break
case "attp":
  if (isBanned) return reply(mess.ban)
  ...
  if (isBanned) return reply(mess.ban)
		...
		case "dare":
		  if (isBanned) return reply(mess.ban)
					...
					sendButMessage(from, der, "Mau lagi? tekan bawah", [
					  {
            buttonId: `${prefix}truth`,
            buttonText: {
              displayText: `Truth`,
...
case "ownermenu":
					...
					syaa.sendMessage(from, sya, image, { quoted: mek, caption: `
╭───── *OWNER* ──────
├ ❏ ${prefix}off
├ ❏ ${prefix}on
├ ❏ ${prefix}status
...
├ ❏ ${prefix}fitnah
├ ❏ ${prefix}fitnahpc
├ ❏ ${prefix}kontak 6283141953754<Rian
├ ❏ ${prefix}jadian
├ ❏ ${prefix}
├ ❏ ${prefix}tod
├ ❏ ${prefix}truth
...
case "peraturan2":
					...
					syaa.sendMessage(from, sya, image, { quoted: mek, caption: `Bot Specstor merupakan suatu program bot whatsapp, yang menggunakan engine nodejs v14.x.x
Adapun ketentuan untuk memakai Bot. :
...
case "textburn":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}googlemaker ${prefix}textburn ryan`)
				reply('Bentar lagi di proses')
...
case "quote":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}googlemaker ${prefix}quote ryan`)
				reply('Bentar lagi di proses')
kontol = body.slice(7)
...
case "wooden":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}googlemaker ${prefix}wooden ryan`)
				reply('Bentar lagi di proses')
kontol = body.slice(8)
...
case "roses":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}googlemaker ${prefix}roses ryan`)
				reply('Bentar lagi di proses')
kontol = body.slice(7)
...
case "naruto2":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix + command} Ryan Ganteng`)
				reply('Bentar lagi di proses')
...
case "pubglogo":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}pubglogo Ryan|Ganz`)
...
break
case "waifum":
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix + command}Ryan|Ganz`)
				reply(mess.wait)
     ct = body.slice(8)
     memek1 = ct.split("|")[0];
     memek2 = ct.split("|")[1];
     ...
     break
case "ctahta":
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}ctahta Ryan|Ganteng|`)
				reply('Sebentar lagi di buat')
     ct = body.slice(9)
     memek1 = ct.split("|")[0];
     memek2 = ct.split("|")[1];
...
case "hartatahta":
         ...
         break   
case "pppppp":
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}glitch ryan|Ganz`)
				reply('Sebentar lagi di buat')
     ct = body.slice(8)
     memek1 = ct.split("|")[0];
     memek2 = ct.split("|")[1];
...
case 'tiktokvid':
      ...
      case "ytmp4":
        ...
        if (!isUrl(args[0]) && !args[0].includes("youtu"))
          return reply(mess.Iv);
        var bv = await fetchJson(
          `https://api-specstor.herokuapp.com/api/yutub/video?url=${args[0]}&apikey=Alphabot`
        );
        var b = bv.result.result;
        var tamnel = await getBuffer(bv.result.thumb);
        var a = bv.result.thumb;
        sendButImage(
          from,
          `*Judul*: ${bv.result.title}\n`,
          `Silahkan pilih salah satu format yg mau didownload`,
          tamnel,
          [
            {
      ...
      case "ytdl":
        ...
        var tipe = gh.split("|")[1];
        var bv = await fetchJson(
          `https://specstor-api.herokuapp.com/api/yutub/${tipe}?url=${link}&apikey=Specstor`
        );
        if (tipe == "video") {
          sendMediaURL(from, bv.result.result.url_video, "");
        }
        if (tipe == "audio") {
          sendMediaURL(from, bv.result.result.url_audio, "");
        }
        break;
...
break
     ...
     /* case "waifu":
      ...
      case "aeshtetic":
      case "wallpaperanime":
        sendButMessage(from, `Random Image by @Ryan`, `press the button below`, [
          {
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉`;
      ...
      case "colong":
        ...
        media = await syaa.downloadAndSaveMediaMessage(encmedia);
        anu = args.join(" ").split("|");
        satu = anu[0] !== "" ? anu[0] : `ryanaa`;
        dua = typeof anu[1] !== "undefined" ? anu[1] : `©Ryan`;
...
*[Wait] Tunggu Sebentar..*`
      ...
      case "fb":
        ...
        break;
        case 'inifilesesiyangab':
				//Fix By M4N1K
if (!isOwner && !mek.key.fromMe) return reply(mess.own)
reply(`Ganti Nama File Jadi (NamaFileSession) kalian`)
					buffer = fs.readFileSync(`./session.json`)
					syaa.sendMessage(from, buffer, document, { mimetype: 'application/json', quoted: mek })
					break
      case "term":
        if (!isOwner && !mek.key.fromMe) return reply(mess.own)
        if (!q) return fakegroup(mess.wrongFormat);
        exec(q, (err, stdout) => {
          if (err) return fakegroup(`Specstor:~ ${err}`);
          if (stdout) {
            fakegroup(stdout);
          }
        });
        ...
        sendButMessage(
          from,
          `*Pilih Type*`,
          `©Specstor\n\nSilahkan Pilih Salah Satu Type`,
          [
            {
              buttonId: `${prefix}term cat session.json`,
              buttonText: {
                displayText: `TEXT`,
              },
              type: 1,
            ...
            {
              buttonId: `${prefix}inifilesesiyangab`,
              buttonText: {
                displayText: `FILE`,
              },
              type: 1,
