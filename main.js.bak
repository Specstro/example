...
const starts = async (client = new WAConnection()) => {
  ...
  client.browserDescription = ["Specstor", "Safari", "3.0"];
  ...
  client.on("qr", () => {
    console.log(
      ...
      color("!", "red"),
      color("]", "white"),
      color("Scan ngab, kalo gk di scan dalam 20 detik dah gk bisa lagi qr nya", "yellow")
    );
  });
  ...
  console.log(
  color("Youtube   : Specstor ", "red"),
  color("\nInstagram : @Specstor ", "blue"),
  color("\nGithub    : Specstro \n", "yellow"),
  );
  ...
  fs.writeFileSync(
    ...
    JSON.stringify(client.base64EncodedAuthInfo(), null, "\t")
        ...
        ownerNumber = ["6281255369681@s.whatsapp.net",`6283141953754@s.whatsapp.net`]
        dtod = "6283141953754@s.whatsapp.net"
       otod = `6283141953754@s.whatsapp.net`
...
function nocache(module, cb = () => {}) {
  console.log(`'${module}'`, "Di Liat Sama Ryan 🗿");
